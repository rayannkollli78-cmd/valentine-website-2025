...
const CONFIG = {
    ...
    questions: {
        first: {
            ...
            secretAnswer: "Je ne t’aime pas juste bien… je t’aime ❤️"           // Secret hover message
        },
        second: {
            text: "À quel point tu m’aimes ?",                          // For the love meter
            startText: "Autant !",                                   // Text before the percentage
    ...
    loveMessages: {
        extreme: "WOOOOW ! Tu m’aimes autant que ça ?? 🥰🚀💝",  // Shows when they go past 5000%
        high: "Jusqu’à l’infini et au-delà !🚀💝",              // Shows when they go past 1000%
        normal: "Et encore plus ! 🥰"                           // Shows when they go past 100%
    },
